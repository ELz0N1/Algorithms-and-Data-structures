...
/*
1000 элементов к сортировке gcc 13

#std::sort baseline:
min_milliseconds=0.0200
median_milliseconds=0.0230

#Use Hoare partition
min_milliseconds=0.0210
median_milliseconds=0.0240
...
min_milliseconds=0.0140
median_milliseconds=0.0170


10 000 000 элементов к сортировке gcc 13
 
#std::sort baseline:
min_milliseconds=558.9980
median_milliseconds=561.4040

#Use Hoare partition
min_milliseconds=539.7490
median_milliseconds=546.3600

#Use Lomuto partition, traditional implementation
min_milliseconds=569.6140
median_milliseconds=571.2990
 
#Use Lomuto partition, branch-free implementation
min_milliseconds=373.7460
median_milliseconds=384.9430
*/